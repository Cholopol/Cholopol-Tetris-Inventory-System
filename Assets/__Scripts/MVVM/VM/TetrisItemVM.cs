...
namespace Cholopol.TIS.MVVM.ViewModels
{
    public class TetrisItemVM : ViewModelBase, ITetrisRotatable
    {
        ...
        private static readonly ItemTextStyle _itemNameTextStyle = new ItemTextStyle(0f, 2f, 0f, 10, new Vector2(0.5f, 0.5f),
        ...
        public ItemDetails ItemDetails
        {
            ...
            set
            {
                if (Set(ref _details, value))
                {
                    ...
                    ItemName = _details != null ? _details.itemName : string.Empty;
                    UpdateRotation();
                }
            }
        }
        ...
        {
            if (_ownedTetrisGridsVM == null) _ownedTetrisGridsVM = new System.Collections.Generic.List<TetrisGridVM>();
