...
namespace Cholopol.TIS
{
    public class RightClickMenuPanel : UIView
    {
        ...
        private TetrisItemView _currentItemView;
        ...
        public void OnShowInfo(object sender, InteractionEventArgs args)
        {
            ...
            ItemInformationPanel.Open(details.itemUI, details.itemName, details.itemDescription);
        }
        ...
        public void OnOpenPanel(object sender, InteractionEventArgs args)
        {
            ...
            if (vm == null) return;
            FloatingPanelManager.Instance.OpenItemWindow(vm);
        }
        ...
        public void SetBtnActive()
        {
            ...
            bool isOpen = FloatingPanelManager.Instance.IsItemWindowOpen(item);
